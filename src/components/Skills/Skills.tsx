...
import DotNetIcon from "../../assets/skills/dotnet.svg?react";
    ...
    >
      ...
      <ul className="grid grid-cols-2 justify-items-center gap-5 md:grid-cols-3 md:gap-5 lg:grid-cols-4 lg:gap-12 xl:grid-cols-5">
        <SkillCard title="Angular">
          <AngularIcon className="group-hover:fill-primary-white" />
        </SkillCard>
        ...
        <SkillCard title=".NET Core">
          <DotNetIcon className="group-hover:fill-primary-white" />
        </SkillCard>
        <SkillCard title="Python">
          <PythonIcon className="group-hover:fill-primary-white" />
        </SkillCard>
        <SkillCard title="SQL">
          <SqlIcon className="group-hover:fill-primary-white" />
        </SkillCard>
